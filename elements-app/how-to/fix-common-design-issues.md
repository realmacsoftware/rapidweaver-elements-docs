...
{% embed url="https://www.youtube.com/watch?v=VvE3h70i844" %}

### Change how things look on mobile (Responsive Design)

The [responsive breakpoint system](../../elements/responsive-breakpoints.md) in Elements allows you to change component properties at different user defined breakpoints (i.e. Mobile, Table, Desktop, etc).
...
{% embed url="https://www.youtube.com/watch?v=x59UfuZvMwM" %}
