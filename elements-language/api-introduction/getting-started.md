...
You can also [add shared files](../shared-files.md) that can be used by all the components in a pack. This videos focuses on [page level Assets](../components/assets.md).
