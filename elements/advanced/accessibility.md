...
* Use accessibility checkers like [WAVE](https://wave.webaim.org/), or Lighthouse (in Chrome DevTools) to audit your pages
* Test with keyboard-only navigation
* Try screen reader testing (VoiceOver on macOS is a good starting point)

### Legal & Compliance

* Aim for [WCAG 2.1 Level AA](https://www.w3.org/TR/WCAG21/) compliance
* If you sell products or services in the EU, ensure you comply with the [European Accessibility Act (EAA)](https://commission.europa.eu/strategy-and-policy/policies/justice-and-fundamental-rights/disability/union-equality-strategy-rights-persons-disabilities-2021-2030/european-accessibility-act_en).
