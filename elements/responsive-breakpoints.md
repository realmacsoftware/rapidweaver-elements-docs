...
Text size and many other controls can change by breakpoint. The following video demonstrates the technique using text size, but you can apply it to most responsive controls in Elements.
