...
The ID name of the component will then appear in the [Link window](link.md#link-panel) enabling you to easily [create Anchors](link.md#linking-to-an-anchor), watch the video below to learn more about how to use this feature.
