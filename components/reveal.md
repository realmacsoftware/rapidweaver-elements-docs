...
By using the `data-reveal-*` attributes in your [Custom Components](../elements/components/custom-components.md), you can take advantage of the Animation framework built into Elements.
...
Animations in [Custom Components](../elements/components/custom-components.md) can be set independently on enter and exit, as shown in the sample code.
