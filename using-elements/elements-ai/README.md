...
| **Grok through Cursor MCP**               | **Second-fastest connected setup**          | Uses the relevant Cursor or model subscription and its usage limits                                               | Working on an Elements project alongside other files and tools in Cursor |
...
Open **Settings > AI > MCP Server** and turn on **Allow AI tools to interact with Elements**. Use **Install…** in the Claude Desktop section, or copy the connection URL into another AI client's MCP settings.
