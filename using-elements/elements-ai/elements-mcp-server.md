...
<figure><img src="../../.gitbook/assets/elements-mcp-server-preferences.png" alt="Elements Preferences showing AI > MCP Server, the enabled Allow AI tools to interact with Elements switch, the Claude Desktop installer, and the local connection URL"><figcaption><p>Enable the MCP server, install the Claude Desktop extension, or copy the local URL for another MCP client.</p></figcaption></figure>
