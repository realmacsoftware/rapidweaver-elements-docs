---
description: Try Elements for free, no purchase required.
...
To help you explore Elements, the trial mode includes the following limitations:
...
You can [Download Elements here](https://elementsapp.io/download/). When the download is complete double-click to unzip the file, then move Elements.app to your Applications Folder.
