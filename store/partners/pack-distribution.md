...
Compiled Element Packs can only be distributed via the Elements Store. These are encrypted, optimised, and safe for distribution.
...
Compiled Element Packs are intended for distribution and sale via the Elements Store.
